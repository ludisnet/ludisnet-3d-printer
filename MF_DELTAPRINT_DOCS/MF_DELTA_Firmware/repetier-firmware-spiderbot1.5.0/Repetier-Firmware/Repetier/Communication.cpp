...
FSTRINGVALUE(Com::tZStored,"Z Value Successfully stored in EEPROM : ")
//FSTRINGVALUE(Com::,"")
...
//FSTRINGVALUE(Com::tZProbeValue3,"Z-probe Y3")
FSTRINGVALUE(Com::tZAdjust1,"Adjust Z Probe #1 by this value (Positive Value Turn CCW / Neg. Value Turn CW / 1 Turn = 1 mm) : ")
FSTRINGVALUE(Com::tZAdjust2,"Adjust Z Probe #2 by this value (Positive Value Turn CCW / Neg. Value Turn CW / 1 Turn = 1 mm) : ")
FSTRINGVALUE(Com::tZSuccessful,"Bed Leveling Successful!! Now, Probing the printer height value at Bed center...")
FSTRINGVALUE(Com::zPrinterHeight,"Calibration Successful, Z Height Value : ")
#endif
